...
API::Std::mod_init('LOLCAT', 'RedStone Development Group', '1.00', '3.0.0a11');
...
=head1 SYNOPSIS
 ...
 <User> !lolcat You too can speak like a lolcat!
 <RedStone> Result: YU T CAN SPEKK LIEK LOLCAT!  KTHXBYE!
